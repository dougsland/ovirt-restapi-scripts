...
if __name__ == "__main__":
	...
	if len(sys.argv) != 5:
		print "Usage: %s my_storage_name address path MyHost" %(sys.argv[0])
		print "Example: %s isoData 192.168.1.103 /nfs/isoData 192.168.1.60" %(sys.argv[0])
		sys.exit(1)

	print "Creating ISO Storage %s" %(sys.argv[1])
