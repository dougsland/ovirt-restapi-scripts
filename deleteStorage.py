...
if __name__ == "__main__":
	...
	# Setting URL
	URL      = "https://" + ADDR + ":" + API_PORT + "/api/datacenters/" + id_ret + "/storagedomains/" + id_st
	...
	request.add_header('Content-Type', 'application/xml')
		...
		print "%s" %(e)
		print "Are you trying to remove an active storage item?"
		print "Are you trying to remove an existing item?"
		print "Are you trying to remove an existing item?"
		print "Are you trying to remove an Unattached storage?"
		print "Check if your Datacenter is UP"
		print "from RHEV-M machine check /var/log/rhevm/rhevm.log"
		sys.exit(-1)
