...
if __name__ == "__main__":
	...
	if len(sys.argv) != 3:
		print "Usage: %s vm_name iso_name" %(sys.argv[0])
		print "Example: %s myVirtualMachine Fedora-10-x86_64-DVD.iso" %(sys.argv[0])
		sys.exit(1)
	...
	# Setting URL
	URL      = "https://" + ADDR + ":" + API_PORT + "/api/vms/" + id_ret + "/cdroms"
	...
	try:
		...
		print "%s" %(e)
		print "value cannot be updated while the virtual machine is up?"
		sys.exit(-1)
